  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <button
          onClick={() => navigate('/local-seller/invoices')}
        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex justify-center">
            <button
              onClick={handleDownload}
              disabled={downloading}
              className="flex items-center gap-2 rounded-md bg-blue-600 px-6 py-3 text-base font-medium text-white hover:bg-blue-700 disabled:opacity-50"
            >
              {downloading ? (
