...
//                       <button
//                         disabled
//                         className="bg-amber-400 text-white px-3 py-1.5 rounded-md text-sm cursor-not-allowed opacity-80"
//                       >
//                         Pending
//                       </button>
...
//                       <button
//                         disabled
//                         className="bg-green-500 text-white px-3 py-1.5 rounded-md text-sm cursor-not-allowed opacity-80"
//                       >
//                         Subscribed
//                       </button>
