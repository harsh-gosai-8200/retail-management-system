...
public class MessageKeys {
    ...
    public static final String SUBSCRIPTION_NOT_FOUND = "error.subscription.notFound";
    public static final String ALREADY_SUBSCRIBED = "error.subscription.alreadySubscribed";
