...
import type { OrderStatus } from '../../../types/salesman';
...
const statusConfig: Record<OrderStatus, { color: string; bg: string; label: string }> = {
  ...
  PROCESSING: { color: 'text-purple-800', bg: 'bg-purple-100', label: 'Processing' },
  SHIPPED: { color: 'text-indigo-800', bg: 'bg-indigo-100', label: 'Shipped' },
  DELIVERED: { color: 'text-green-800', bg: 'bg-green-100', label: 'Delivered' },
